...
class FinetuningArguments(
    ...
    enable_partial_perference_learning: bool = field(
        default=False,
        metadata={"help": "Whether or not to enable partial preference learning."},
    )
    auxilary_sft_coef_in_pl: Optional[float] = field(
        default=None,
        metadata={"help": "Coefficient for the auxiliary SFT loss in partial preference learning. None means not using it."},
    )
